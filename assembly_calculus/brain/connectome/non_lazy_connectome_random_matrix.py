...
class NonLazyConnectomeRandomMatrix(ABCConnectome):
    ...
    def __init__(self, p: float, areas=None, stimuli=None, connections=None, initialize=False):
        ...
        """
        super(NonLazyConnectomeRandomMatrix, self).__init__(p, areas, stimuli)
    ...
    def _initialize_connection(self, part: BrainPart, area: Area):
        ...
        :return:
        """
        synapses = RandomMatrix(part.n, area.n, self.p).values
    ...
    def subconnectome(self, connections: Dict[BrainPart, List[Area]]) -> ABCConnectome:
        ...
        nlc = NonLazyConnectomeRandomMatrix(self.p, areas=list(areas), stimuli=stimuli, connections=neural_subnet,
                                initialize=False)
        return nlc
