...
class NonLazyConnectome(Connectome):
	...
	def project(self, connections: Dict[BrainPart, Iterable[Area]], override_winners=None, enable_plasticity=True):
		...
		for area in to_update:
			if area in override_winners:  # In case of enforcing some winners to some area
