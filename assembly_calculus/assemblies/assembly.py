...
class AssemblySet(UniquelyIdentifiable):
    ...
    def merge(self, area: Area, *, brain: Brain = None) -> Assembly:
        ...
        if brain is not None:
            ...
            brain.next_round(subconnectome=subconnectome, iterations=brain.repeat * MERGE_REPEAT)
    ...
    def associate(self, other: Optional[AssemblySet], *, brain: Brain):
        ...
        for x, y in pairs:
            ...
            brain.next_round(subconnectome=subconnectome, iterations=brain.repeat * ASSOCIATE_REPEAT)
...
class Assembly(UniquelyIdentifiable):
    ...
    def project(self, area: Area, *, brain: Brain = None) -> Assembly:
        ...
        if brain is not None:
            ...
            brain.winners[area] = list()
            brain.next_round(subconnectome={self.area: [area], area: [area]},
    ...
    def reciprocal_project(self, area: Area, *, brain: Brain = None) -> Assembly:
        ...
        if brain is not None:
            ...
            brain.next_round(subconnectome=subconnectome, iterations=brain.repeat * RECIPROCAL_PROJECT_REPEAT)
