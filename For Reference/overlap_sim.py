""" Collection of simulations for preservation overlap in assemblies.
 ...
 In our efficiently computable sampling-trick simulation (aka sparsity), it is not obvious
